...
public class SecurityServiceTest
{
    ...
    @Mock
    private GetJoggingTimesByUserWithFilterRQ request;

    @Before
    public void setUp() throws Exception
    {
        securityService.setApiClientUtils(apiClientUtils);
    ...
    {
        // when
        securityService.joggingTimeBelongsToAuthUser("joggingTimesId");
    ...
    public void shouldPostForEntityUsingRestTemplate() throws JSONException
    {
        ...
        // then
        verify(restTemplate).postForEntity("/select", httpEntity, ServiceResult.class);
    }
}
